...
#      Exercise Description: Parking sensor exercise tests
#
...
tests = [ {'description': 'PINA: 0x01 => PORTC: 0x03',    
    ...
    'steps' : [ {'input': [('PINA',0x08)], 'iterations': 5 } ],
    'expected': [('PORTC',0x03)],
    },
    {'description': 'PINA: 0x03 => PORTC: 0x02',
    'steps' : [ {'input': [('PINA',0x03)], 'iterations': 5 } ],
    'expected': [('PORTC',0x02)],
    },
    {'description': 'PINA: 0x05 => PORTC: 0x02',
    'steps' : [ {'input': [('PINA',0x05)], 'iterations': 5 } ],
    'expected': [('PORTC',0x02)],
    },
    {'description': 'PINA: 0x06 => PORTC: 0x02',
    'steps' : [ {'input': [('PINA',0x06)], 'iterations': 5 } ],
    'expected': [('PORTC',0x02)],
    },
    {'description': 'PINA: 0x07 => PORTC: 0x01',
    'steps' : [ {'input': [('PINA',0x07)], 'iterations': 5 } ],
    'expected': [('PORTC',0x01)],
    },
    {'description': 'PINA: 0x0F => PORTC: 0x00',
    'steps' : [ {'input': [('PINA',0x0F)], 'iterations': 5 } ],
    'expected': [('PORTC',0x00)],
    },
    ]
#watch = ['PORTB']
