...
#      Exercise Description: Counter exercise tests
#
...
tests = [{'description': 'PINA: 0x0 => PORTB: 0x07',
    ...
    {'description': 'PINA: 0x00 => PORTB: 0x08',
    'steps': [{'inputs': [('PINA', 0x00)], 'iterations': 2}],
    'expected': [('PORTB',0x08)],
    },
    {'description': 'PINA: 0x02 => PORTB: 0x07',
    'steps': [{'inputs': [('PINA', 0x02)], 'iterations': 2}],
    'expected': [('PORTB',0x07)],
    },
    {'description': 'PINA: 0x01, 0x00, 0x01 => PORTB: 0x09',
    'steps': [{'inputs': [('PINA', 0x01)], 'iterations': 2},
        {'inputs': [('PINA', 0x00)], 'iterations': 2},
        {'inputs': [('PINA', 0x01)], 'iterations': 2}],
    'expected': [('PORTB',0x08)],
    },
    {'description': 'PINA: 0x03 => PORTB: 0x07',
